package com.joeydalu.vpd.view.custom;
...
public class CircleProgressBar extends View {
    ...
    // Font of the progress value of the progress bar
    private int mProgressFont;
    ...
    private void initFromAttributes(Context context, AttributeSet attrs) {
        ...
        mProgressFont = a.getResourceId(R.styleable.CircleProgressBar_progress_text_font, R.font.josefin_sans_medium);
    ...
    private void initPaint() {
        ...
        mProgressTextPaint.setTypeface(ResourcesCompat.getFont(getContext(), mProgressFont));
